...
skip_existing = (
    "Check if the object with given ID exists before inserting, and skip it if it does. "
...
update_existing = (
    "Check if the object with given ID exists before inserting, and update it if it does. "
