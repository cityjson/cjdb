filepath_help = (
    "Source CityJSONL file or a directory with CityJSONL files. "
...
append_help = (
    ...
    + "This assumes the database structure exists already and new data is to be"
    " appended."
)

overwrite_help = (
    "Overwrite the data that is currently in the database schema. "
    + "Warning: this causes the loss of what was imported before to the database"
    " schema."
)

ignore_file_help = (
    "Ignore repeated file names warning when importing. "
    + "By default, the importer will send out warnings if a specific file has already"
    " been imported."
)

skip_existing = (
    "Check if the object with given ID exists before inserting, and skip it if it"
    " does. "
...
update_existing = (
    "Check if the object with given ID exists before inserting, and update it if it"
    " does. "
